    ...
    return (
			<div id="contact" className="w-full lg:h-screen">
				<div className="max-x-[1240px] m-auto px-2 py-16 w-full">
					<p className="text:xl tracking-widest uppercase text-blue-400">
						Contact
					</p>
					...
					<div className="bg-white m-auto col-span-3 lg:col-span-2 w-[85%] h-full shadow-xl shadow-gray-400 rounded-xl p-4">
						<div className="lg:p-4 h-full">
							...
							<div>
								...
								<p className="py-4">
									Contact me and lets talk about what I can do for your company.
								</p>
							</div>
						</div>
						<div>
					...
					<div
						id="email"
						className="bg-white m-auto mt-5 col-span w-[85%] h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4"
					>
						<div className="p-4">
							<form onSubmit={sendEmail}>
								...
								<button className="w-full p-4 text-gray-100 bg-blue-400 mt-4 rounded-lg">
									{submitText}
								</button>
							</form>
						</div>
